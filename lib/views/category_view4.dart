...
class CategoryView4 extends StatefulWidget {
  final String cid;
  CategoryView4({this.cid});

  @override
  _CategoryView4State createState() => _CategoryView4State();
}


class _CategoryView4State extends State<CategoryView4> {
  bool _loading = true;
  List<NewsModel> results = new List<NewsModel>();
  List<NewsModel> catnews4 = [];
  ...
  void initState() {
    ...
    super.initState();
    getCatView(globals.initialCat4Url);
