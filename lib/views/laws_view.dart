...
class LawsView extends StatefulWidget {
  LawsView();

  @override
  _LawsViewState createState() => _LawsViewState();
}

class _LawsViewState extends State<LawsView> {
  bool _loading = true;
  ...
  getLawsView() async {
    LawsViewClass newsClass = LawsViewClass();
