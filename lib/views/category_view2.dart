...
class CategoryView2 extends StatefulWidget {
  final String cid;
  CategoryView2({this.cid});

  @override
  _CategoryView2State createState() => _CategoryView2State();
}
...
class _CategoryView2State extends State<CategoryView2> {
  ...
  void initState() {
    ...
    super.initState();
    getCatView(globals.initialCat2Url);
